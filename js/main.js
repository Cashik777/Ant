...
const PRODUCTS = [
    ...
    { id: 2, name: 'Йіргачеффе', region: 'Yirgacheffe', desc: 'Цветочный, цитрусовый. Идеален для фильтра.', price: 280, weight: 250, roast: 'light', taste: ['🌸', '🍋'], method: ['filter'], image: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=800' },
    { id: 3, name: 'Гуджі Натурал', region: 'Guji', desc: 'Ягодний вибух. Полуниця, манго, мед.', price: 320, weight: 250, roast: 'light', taste: ['🍓', '🥭'], method: ['filter'], image: 'https://images.unsplash.com/photo-1611854779393-1b2ae9d98e70?w=800' },
    { id: 4, name: 'Еспресо Бленд', region: 'Blend', desc: 'Стабільний смак для еспресо. Шоколад, карамель.', price: 220, weight: 250, roast: 'dark', taste: ['🍫', '🍬'], method: ['espresso'], image: 'https://images.unsplash.com/photo-1510707577719-ae7c9b788690?w=800' },
    { id: 5, name: 'Лімму', region: 'Limmu', desc: 'Збалансований. Зелене яблуко, карамель.', price: 260, weight: 250, roast: 'medium', taste: ['🍏', '🍬'], method: ['espresso', 'filter'], image: 'https://images.unsplash.com/photo-1587734195507-6b7c8b6a3e5a?w=800' },
    { id: 6, name: 'Харар', region: 'Harrar', desc: 'Дикий. Чорниця, вино, спеції.', price: 340, weight: 250, roast: 'light', taste: ['🫐', '🍷'], method: ['filter'], image: 'https://images.unsplash.com/photo-1621262974917-76b4a39f60af?w=800' }
];
